...
var CanvasContainer = function CanvasContainer(_ref) {
  var image = _ref.image,
      pixelSize = _ref.pixelSize,
      gridSize = _ref.gridSize,
      gridColor = _ref.gridColor,
      pixelType = _ref.pixelType;
  var canvas;
  var isDrawing = false;
  var canvasFirstData;
  var mousedownHandler = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (e) {
    ...
    canvasFirstData = Object(_utils_drawMousemoveCanvas__WEBPACK_IMPORTED_MODULE_3__["drawMousemoveCanvas"])(canvas, pixelSize, gridSize, x, y, gridColor);
    ctx.putImageData(canvasFirstData, 0, 0);
  }, [pixelSize, gridSize, gridColor, pixelType]);
  var mousemoveHandler = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (e) {
    var ctx = canvas.getContext("2d");
    var rect = canvas.getBoundingClientRect();
    var x = e.clientX - rect.left;
    var y = e.clientY - rect.top;
    ...
    if (!isDrawing) {
      ctx.putImageData(canvasFirstData, 0, 0);
      ctx.putImageData(Object(_utils_drawHoverCanvas__WEBPACK_IMPORTED_MODULE_4__["drawHoverCanvas"])(canvas, pixelSize, gridSize, x, y, gridColor), 0, 0);
      return;
    }
  ...
  var mouseleaveHandler = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function () {
    var ctx = canvas.getContext("2d");
    ctx.putImageData(canvasFirstData, 0, 0);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    if (pixelType === "square") {
      Object(_utils_drawCanvas__WEBPACK_IMPORTED_MODULE_1__["drawCanvas"])(canvas, image, pixelSize, gridSize, gridColor);
    } else if (pixelType === "circle") {
      Object(_utils_drawCanvasCircle__WEBPACK_IMPORTED_MODULE_6__["drawCanvasCircle"])(canvas, image, pixelSize, gridSize, gridColor);
    } else if (pixelType === "original") {
      Object(_utils_drawCanvasOriginal__WEBPACK_IMPORTED_MODULE_5__["drawCanvasOriginal"])(canvas, image);
    } else if (pixelType === "roundsquare") {
      Object(_utils_drawCanvasRoundSquare__WEBPACK_IMPORTED_MODULE_7__["drawCanvasRoundSquare"])(canvas, image, pixelSize, gridSize, gridColor);
    }
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    canvasFirstData = ctx.getImageData(0, 0, canvas.width, canvas.height);
    canvas = document.querySelector("#canvas");
    canvas.addEventListener("mousemove", _utils_pickColor__WEBPACK_IMPORTED_MODULE_2__["pickColor"]);
    ...
    return function () {
      canvas.removeEventListener("mousemove", _utils_pickColor__WEBPACK_IMPORTED_MODULE_2__["pickColor"]);
...
var borderSize = 2;
var drawCanvas = function drawCanvas(canvas, image, pixelSize, gridSize, gridColor) {
  gridColor = gridColor || "#000000";
  console.log("drawCanvas ps", pixelSize);
  var ctx = canvas.getContext("2d");

  var _resizeImage = Object(_resizeImage__WEBPACK_IMPORTED_MODULE_0__["resizeImage"])(image),
      _resizeImage2 = _slicedToArray(_resizeImage, 2),
      width = _resizeImage2[0],
      height = _resizeImage2[1];
  ...
  var gridBlue = parseInt(gridColor.substr(5, 2), 16); // Loop through each tile

  for (var r = 0; r < numTileRows; r++) {
    for (var c = 0; c < numTileCols; c++) {
      // Set the pixel values for each tile
      var average = void 0;
      if (c === numTileCols - 1 || r === numTileRows - 1) average = Object(_averageLastPixelColor__WEBPACK_IMPORTED_MODULE_2__["averageLastPixelColor"])(canvas, r, c, ctx, tileSize, dataOffset);else average = Object(_averageColor__WEBPACK_IMPORTED_MODULE_1__["averageColor"])(r, c, ctx, tileSize, dataOffset);
      var rgb = average;
      var red = rgb.r;
      var green = rgb.g;
      var blue = rgb.b; // Loop through each tile pixel
      ...
      if (c === numTileCols - 1) {
        for (var tr = 0; tr < tileSize; tr++) {
          for (var tc = 0; tc < canvas.width - c * tileSize; tc++) {
            ...
            var trueCol = c * tileSize + tc; // Calculate the position of the current pixel in the array

            var position = trueRow * (imageData.width * dataOffset) + trueCol * dataOffset; // console.log("position", position);
        ...
        for (var _tr = 0; _tr < tileSize; _tr++) {
          for (var _tc = 0; _tc < tileSize; _tc++) {
            // Calculate the true position of the tile pixel
            var _trueRow = r * tileSize + _tr;

            var _trueCol = c * tileSize + _tc; // Calculate the position of the current pixel in the array


            var _position = _trueRow * (imageData.width * dataOffset) + _trueCol * dataOffset; // console.log("position", position);
            // Assign the colour to each pixel


            if (_tc < grid || _tr < grid || _tr > canvas.height - r * tileSize - grid) {
              pixels[_position + 0] = gridRed;
              pixels[_position + 1] = gridGreen;
              pixels[_position + 2] = gridBlue;
              pixels[_position + 3] = 255;
            } else {
              pixels[_position + 0] = red;
              pixels[_position + 1] = green;
              pixels[_position + 2] = blue;
              pixels[_position + 3] = 255;
            }
          }
        }
...
var resizeImage = function resizeImage(image) {
  var MAX_WIDTH = document.getElementById("canvas-container").getBoundingClientRect().width - 1;
  var MAX_HEIGHT = document.getElementById("canvas-container").getBoundingClientRect().height - 1;
  var width = image.width;
  var height = image.height; // 아트보드 가로세로 비율

  var artboardRatio = MAX_WIDTH / MAX_HEIGHT; // 이미지 가로세로 비율

  var imageRatio = width / height; // 아트보드 비율이 이미지 비율보다 크면 이미지의 세로를 아트보드의 세로에 맞춤
...
var averageColor = function averageColor(row, column, ctx, tileSize, dataOffset) {
  var rgb = {
    r: 0,
    g: 0,
    b: 0
...
var sizeOffset = 10;
var averageLastPixelColor = function averageLastPixelColor(canvas, row, column, ctx, tileSize, dataOffset) {
  var rgb = {
    r: 0,
    g: 0,
    b: 0
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pickColor", function() { return pickColor; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "drawMousemoveCanvas", function() { return drawMousemoveCanvas; });
var dataOffset = 4; // we can set how many pixels to skip

var drawMousemoveCanvas = function drawMousemoveCanvas(canvas, pixelSize, gridSize, y, x, gridColor) {
  ...
  var colIndex = Math.floor(y / tileSize); // Set the pixel values for each tile
  ...
  if (colIndex === numTileCols - 1) {
    for (var tr = 0; tr < tileSize; tr++) {
      for (var tc = 0; tc < canvas.width - colIndex * tileSize; tc++) {
        ...
        var trueCol = colIndex * tileSize + tc; // Calculate the position of the current pixel in the array
    ...
    for (var _tr = 0; _tr < tileSize; _tr++) {
      for (var _tc = 0; _tc < tileSize; _tc++) {
        // Calculate the true position of the tile pixel
        var _trueRow = rowIndex * tileSize + _tr;

        var _trueCol = colIndex * tileSize + _tc; // Calculate the position of the current pixel in the array


        var _position = _trueRow * (canvas.width * dataOffset) + _trueCol * dataOffset; // console.log("position", position);
        // Assign the colour to each pixel
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "drawHoverCanvas", function() { return drawHoverCanvas; });
var dataOffset = 4; // we can set how many pixels to skip

var drawHoverCanvas = function drawHoverCanvas(canvas, pixelSize, gridSize, y, x, hoverColor) {
  console.log("mCanvas ps", pixelSize);
  var tileSize = pixelSize;
  var numTileCols = Math.ceil(canvas.width / tileSize);
  var ctx = canvas.getContext("2d");
  ...
  if (colIndex === numTileCols - 1) {
    ...
    for (var _tr = 0; _tr < tileSize; _tr++) {
      for (var _tc = 0; _tc < tileSize; _tc++) {
        ...
        if (_tc < grid || _tr < grid || _tr > canvas.height - rowIndex * tileSize - grid) {
          pixels[_position + 0] = gridRed;
          pixels[_position + 1] = gridGreen;
          pixels[_position + 2] = gridBlue;
          pixels[_position + 3] = 255;
...
var borderSize = 2;
var drawCanvasOriginal = function drawCanvasOriginal(canvas, image) {
  var ctx = canvas.getContext("2d");
...
var borderSize = 2;
var drawCanvasCircle = function drawCanvasCircle(canvas, image, pixelSize, gridSize, gridColor) {
  gridColor = gridColor || "#000000";
  console.log("drawCanvas ps", pixelSize);
  var ctx = canvas.getContext("2d");
  ...
  for (var r = 0; r < numTileRows; r++) {
    for (var c = 0; c < numTileCols; c++) {
      ...
      ctx.beginPath();
      ctx.fillStyle = "".concat(gridColor);
      ctx.fillRect(trueRow, trueCol, tileSize, tileSize);
      ctx.fillStyle = "rgb(".concat(red, ",").concat(green, ",").concat(blue, ")");
...
var borderSize = 2;
var drawCanvasRoundSquare = function drawCanvasRoundSquare(canvas, image, pixelSize, gridSize, gridColor) {
  gridColor = gridColor || "#000000";
  console.log("drawCanvas ps", pixelSize);
  var ctx = canvas.getContext("2d");
  ...
  for (var r = 0; r < numTileRows; r++) {
    for (var c = 0; c < numTileCols; c++) {
      ...
      ctx.fillRect(trueRow, trueCol, tileSize, tileSize);
      ctx.fillStyle = "rgb(".concat(red, ",").concat(green, ",").concat(blue, ")");
      ctx.strokeStyle = "rgb(".concat(red, ",").concat(green, ",").concat(blue, ")");
      var radius = tileSize * 20 / 100;
      roundRect(ctx, trueRow + grid, trueCol + grid, tileSize - grid, tileSize - grid, radius, true);
      console.log(ctx, trueRow + gridSize, trueCol + gridSize, tileSize - gridSize, tileSize - gridSize, radius, true); // ctx.fillRect(trueRow + gridSize, trueCol + gridSize, tileSize - gridSize, tileSize - gridSize);
    }
  } // const imageData2 = ctx.getImageData(0, 0, canvas.width, canvas.height);
  // const pixels2 = imageData2.data;
  // for (let r = 0; r < numTileRows; r++) {
...
var Pixel = function Pixel(_ref) {
  var pixelSize = _ref.pixelSize,
      updatePixelSize = _ref.updatePixelSize;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    type: "range",
    value: pixelSize,
    onChange: function onChange(e) {
      return updatePixelSize(e);
    },
    min: 10,
    max: 140
  });
...
var Grid = function Grid(_ref) {
  var gridSize = _ref.gridSize,
      updateGridSize = _ref.updateGridSize;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    type: "range",
    value: gridSize,
    onChange: function onChange(e) {
...
var GridColor = function GridColor(_ref) {
  var gridColor = _ref.gridColor,
      updateGridColor = _ref.updateGridColor;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    type: "text",
    value: gridColor,
    onChange: function onChange(e) {
      return updateGridColor(e);
    }
  });
};
...
var PixelType = function PixelType(_ref) {
  var pixelType = _ref.pixelType,
      updatePixelType = _ref.updatePixelType;
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    var container = document.getElementById("pixeltype-radio-container");
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    onChange: function onChange() {
      return updatePixelType("square");
    }
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", {
    htmlFor: "radio-square"
  }, "Square"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    type: "radio",
    id: "radio-roundsquare",
    value: "roundsquare",
    name: "pixel-type",
    onChange: function onChange() {
      return updatePixelType("roundsquare");
    }
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", {
    htmlFor: "radio-roundsquare"
  }, "Round Square")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    type: "radio",
    id: "radio-original",
    value: "original",
    name: "pixel-type",
    onChange: function onChange() {
      return updatePixelType("original");
    }
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", {
    htmlFor: "radio-original"
  }, "Original"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    type: "radio",
    id: "radio-circle",
    value: "circle",
    name: "pixel-type",
    onChange: function onChange() {
      return updatePixelType("circle");
    }
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", {
...
var UploadContainer = function UploadContainer(_ref) {
  var updateImageData = _ref.updateImageData;
  ...
  }, "UPLOAD IMAGE"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
